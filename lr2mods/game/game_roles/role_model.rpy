...
label photo_be_sexy(the_person):
    ...
    if the_person.bra_covered or the_person.panties_covered: #She has underwear on and something over both.
        ...
        $ outfit_state = 2 #She's practically naked with no clothing on.
    menu:
        "Strip to your underwear" if slut_willingness+skimpy_uniform_bonus >= 30 and outfit_state == 0:
            #TODO: Also check to make sure she's got the right type of clothing TO strip down to her underwear
...
label photo_sex(the_person):
    ...
    #TODO: Add a crisis where her boyfriend recognises her after this event has taken place.
